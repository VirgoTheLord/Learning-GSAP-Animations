...
document.fonts.ready.then(() => {
    ...
    function animateProgress(duration = 4){
        ...
        for(let i = 0; i < counterSteps; i++){
            const finalSteps = i === counterSteps - 1;
            const targetProgress = finalSteps ? 1 : Math.min(currentProgress + Math.random() * 0.3 + 0.1,0.9);
